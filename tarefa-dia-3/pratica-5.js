...
//let somaTotalDeVendasAbaixoDe50 = 0;
...
//for(let i=0 ; i<receita.length; i++){
  ...
  //  const valorTotalDeUmaVenda = receita[i].valor + receita[i].gorjeta
    ...
    //if(valorTotalDeUmaVenda < 50)
      //  somaTotalDeVendasAbaixoDe50++
    //}
//console.log(`Número de vendas abaixo de 50 são : ${vendasAbaixoDe50Reais}`)
/* PROBLEMA 1: Qual o valor total de vendas sem gorjeta? --------------------- */
//COLOQUE SUA SOLUÇÃO AQUI

// O valor total de vendas sem gorjeta foi de 49796

// Solução :

// let somaTotalDeVendasSemGorjeta = 0;

// for(let i=0 ; i<receita.length ; i++){

//    somaTotalDeVendasSemGorjeta = receita[i].valor + somaTotalDeVendasSemGorjeta;

//}

// console.log(`O valor total de vendas sem gorjetas são de : ${somaTotalDeVendasSemGorjeta}`)
...
// O valor total de vendas incluindo a gorjeta foi de : 54775.60000000002

// A solução é :
//let somaTotalDeVendasComGorjeta = 0;
//for(let i=0 ; i<receita.length ; i++){
//    somaTotalDeVendasComGorjeta = receita[i].valor + receita[i].gorjeta + somaTotalDeVendasComGorjeta;
//}
//     console.log(`O valor total de vendas incluído as gorjetas são de : ${somaTotalDeVendasComGorjeta}`)
...
// Foram feitas 4 vendas abaixo de 50 reais
